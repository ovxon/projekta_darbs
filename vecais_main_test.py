...
print("Šī ir testa versija, kurā pirms īstā laukuma tiek izvadīts laukums ar visiem atlikušajiem 'mērķiem'")
...
def laukuma_izvade(): #izvada laukumu teksta formā
    print("Laukums ar visiem atlikušajiem mērķiem:")
    for i in range(len(laukums)):
        for j in range(len(laukums)):
            print(laukums[i][j], end = "\t")
        print()
    print("Lietotājam redzamais laukums:")
